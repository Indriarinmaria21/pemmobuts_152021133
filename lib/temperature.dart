          ...
          child: Column(
            ...
            children: [
                  ...
                  return DropdownMenuItem<String>(
                    ...
                    child: Text(
                      ...
                      style: const TextStyle(
                          fontSize: 20, fontFamily: 'ChakraPetch'),
                    ),
                  );
                }).toList(),
                underline: Container(
                ...
                children: [
                    ...
                    child: TextField(
                      ...
                      decoration: const InputDecoration(
                        ...
                        labelStyle: TextStyle(
                            ...
                            color: Color.fromARGB(255, 245, 105, 105)),
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: const Color.fromARGB(255, 216, 152, 152),
              ...
              DropdownButton<String>(
                ...
                underline: Container(
                  height: 2,
                  color: const Color.fromARGB(255, 197, 138, 138),
                ),
              ),
              ...
              Center(
                child: Text(
                  ...
                  style:
                      const TextStyle(fontSize: 24, fontFamily: 'ChakraPetch'),
                ),
              ),
            ],
          ),
